...
PASTA_SAIDA = BASE_DIR / "dados_mnq_2024_ibkr"
PASTA_SAIDA.mkdir(parents=True, exist_ok=True)

ARQ_FINAL = PASTA_SAIDA / "MMNQ_2024_2MIN_IBKR_CONTINUO.csv"
...
def baixar_contrato(ib, cfg):
    ...
    arq_contrato = PASTA_SAIDA / f"MNQ_2024_2MIN_IBKR_{cfg['nome']}.csv"
...
def main():
    print("=====================================================")
    print("BAIXAR MNQ 2024 IBKR - 2 MIN POR CONID")
    print("=====================================================")
