...
ARQ_FEATURES_2026 = PASTA_SAIDA / "01_2026_features_config_atual_sem_0430.csv.gz"
ARQ_SCORE_2026 = PASTA_SAIDA / "02_2026_score_config_atual_sem_0430.csv.gz"
ARQ_TRADES_2026 = PASTA_SAIDA / "03_2026_trades_config_atual_sem_0430.csv.gz"
ARQ_RESUMO_2026 = PASTA_SAIDA / "04_2026_resumo_config_atual_sem_0430.csv"
ARQ_ANALISE_2026 = PASTA_SAIDA / "05_2026_analise_config_atual_sem_0430.csv"


# ============================================================
# CONFIGURAÇÃO V4 ATUAL
# ============================================================
...
HORA_BLOQUEIO_INICIO = 4.5    # 04:30
HORA_BLOQUEIO_FIM = 4.75      # antes de 04:45


# ============================================================
# APLICAR CONFIGURAÇÃO V4 ATUAL + BLOQUEIO 04:30
# ============================================================

def aplicar_config_atual_sem_0430(df):
    if df.empty:
        return pd.DataFrame()
...
def main():
    print("=====================================================")
    print("VALIDAÇÃO V4 ATUAL 2026 - SEM BLOCO 04:30")
    print("=====================================================")
    ...
    trades = aplicar_config_atual_sem_0430(score_resultado)
    ...
    print("\n=====================================================")
    print("RESULTADO FORA DA AMOSTRA 2026 - V4 ATUAL SEM 04:30")
    print("=====================================================")
    ...
    print("\nComparação alvo:")
    print("V4 antiga 2026 : 159 trades | 77,98% | +2167 pontos | PF 1.52")
    print("V4 atual 2026  : 169 trades | 76,92% | +2002 pontos | PF 1.43")
    print("Este teste     : V4 atual com bloqueio 04:30-04:44")
