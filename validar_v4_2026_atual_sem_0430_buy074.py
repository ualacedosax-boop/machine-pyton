...
ARQ_FEATURES_2026 = PASTA_SAIDA / "01_2026_features_atual_sem_0430_buy074.csv.gz"
ARQ_SCORE_2026 = PASTA_SAIDA / "02_2026_score_atual_sem_0430_buy074.csv.gz"
ARQ_TRADES_2026 = PASTA_SAIDA / "03_2026_trades_atual_sem_0430_buy074.csv.gz"
ARQ_RESUMO_2026 = PASTA_SAIDA / "04_2026_resumo_atual_sem_0430_buy074.csv"
ARQ_ANALISE_2026 = PASTA_SAIDA / "05_2026_analise_atual_sem_0430_buy074.csv"
...
def resumir_trades(trades):
    if trades.empty:
        return pd.DataFrame([{
            "versao": "V4_ATUAL_SEM_0430_BUY074",
...
def main():
    print("=====================================================")
    print("VALIDAÇÃO V4 ATUAL 2026 - SEM 04:30 - BUY 0.74")
    print("=====================================================")
    ...
    print("\n=====================================================")
    print("RESULTADO FORA DA AMOSTRA 2026 - SEM 04:30 - BUY 0.74")
    print("=====================================================")
    ...
    print("Este teste   : V4 atual sem 04:30 com BUY 0.74")
