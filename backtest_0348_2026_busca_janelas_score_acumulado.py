...
# ============================================================
# IMPORTA O CÓDIGO BASE JÁ EXISTENTE
# ============================================================
...
BASE_DIR = Path(r"C:\Users\ualac\Documents\2026\Mercado\machine-pyton")
...
# Vai testar com e sem filtro V4
TESTAR_FILTRO_V4 = [False, True]

# Janelas acumuladas que serão testadas.
...
PASTA_SAIDA = BASE_DIR / "backtest_0348_2026_busca_janelas_score_acumulado"
...
# ============================================================
# LOCALIZAR CANDLES 2026
# ============================================================

def localizar_candles_2026():
    candidatos = [
        BASE_DIR / "dados_mnq_2026_ibkr" / "MNQ_2026_2MIN_IBKR_CONTINUO.csv",
        BASE_DIR / "dados_mnq_2026_ibkr" / "MNQ_2026_2MIN_IBKR.csv",
        BASE_DIR / "dados_mnq_2026" / "MNQ_2026_2MIN_IBKR_CONTINUO.csv",
        BASE_DIR / "MNQ_2026_2MIN_IBKR_CONTINUO.csv",
    ]
    ...
    raise FileNotFoundError(
        "Não encontrei o arquivo de candles 2026. "
        "Verifique se existe MNQ_2026_2MIN_IBKR_CONTINUO.csv dentro do projeto."
    )
...
def main():
    print("=====================================================")
    print("BACKTEST 2026 - 03:48 - BUSCA DE JANELAS DE SCORE")
    print("=====================================================")
    ...
    # Detalhe menor para leitura rápida
    detalhe_cols = [
        "DataHora_SP",
        "janela_nome",
        "usar_filtro_v4",
    ...
    print("\n=====================================================")
    print("RANKING DAS JANELAS - 03:48")
    print("=====================================================")
